...
class User {
    ...
    public static function enable(){
        \add_action('rest_api_init', function () {
            register_rest_route('ion-chat/v1', '/app-password', array(
                'methods' => 'POST',
                'callback' => ['\IonChatMothership\User', 'handle_app_password_submission'],
            ...
            register_rest_route('ion-chat/v1', '/app-password', array(
                'methods' => 'DELETE',
                'callback' => ['\IonChatMothership\User', 'handle_app_password_deletion'],
                'permission_callback' => function () {
    ...
    public static function enable_user_edit_app_passwords_screen(){
        \add_action('show_user_profile', '\IonChatMothership\User::add_custom_user_profile_fields');
        \add_action('edit_user_profile', '\IonChatMothership\User::add_custom_user_profile_fields');
    }
    ...
    public static function add_custom_user_profile_fields($user) {
        ...
        <div id="application-passwords-storage">
            <h2><?php _e("Ion Chat Application Passwords", "ion-chat"); ?></h2>
            ...
            <p class="submit">
                <button type="button" class="button button-secondary" onclick="submitRemoteAppPasswordForm();"><?php _e('Add Remote Application Password', 'ion-chat'); ?></button>
            </p>
            <script type="text/javascript">
                function updatePasswordTable(passwords) {
                    var table = jQuery('#ion-chat-app-passwords-table tbody');
                ...
                document.querySelector('#ion-chat-app-passwords-table').addEventListener('click', function(event) {

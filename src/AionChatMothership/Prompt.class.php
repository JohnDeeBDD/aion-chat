...
class Prompt extends \AionChat\Prompt {
    ...
    public function init_this_prompt($comment_id, $status){
        ...
        //$this->user_id = \AionChat\User::get_ion_user_id();
        //$this->user_email = \AionChat\User::get_ion_email();
        $this->set_messages();
        // Set the status
        $this->status = $status;
    }
    ...
    public function send_down(){
        ...
        $response = \wp_remote_post( $this->origin_domain_url . "/wp-json/aion-chat/v1/ion-prompt", array(
                'method'      => 'POST',
                'timeout'     => 45,
                'redirection' => 5,
                'httpversion' => '1.0',

...
$SSH_Commands = [
    ...
    "ssh -o StrictHostKeyChecking=no -i /home/johndee/ozempic.pem ubuntu@" . $dev1IP . ' wp plugin activate email-tunnel/email-tunnel --path=/var/www/html',
    "ssh -o StrictHostKeyChecking=no -i /home/johndee/ozempic.pem ubuntu@" . $dev1IP . ' wp plugin activate email-tunnel/EmailTunnelMothership --path=/var/www/html',
    ...
    "ssh -o StrictHostKeyChecking=no -i /home/johndee/ozempic.pem ubuntu@" . $dev2IP . ' wp plugin activate email-tunnel/email-tunnel --path=/var/www/html',
...
$fp = fopen('/var/www/html/wp-content/plugins/email-tunnel/servers.json', 'w');
fwrite($fp, json_encode($servers));
fclose($fp);

echo("Copying servers.json to remotes:" . PHP_EOL);
$command = "scp -i /home/johndee/ozempic.pem servers.json ubuntu@$dev1IP:/var/www/html/wp-content/plugins/email-tunnel/servers.json";
echo ($command . PHP_EOL);shell_exec($command);
$command = "scp -i /home/johndee/ozempic.pem servers.json ubuntu@$dev2IP:/var/www/html/wp-content/plugins/email-tunnel/servers.json";
echo ($command . PHP_EOL);shell_exec($command);
...
$command = "ssh -o StrictHostKeyChecking=no -i /home/johndee/ozempic.pem ubuntu@" . $dev1IP . " php /var/www/html/wp-content/plugins/email-tunnel/startupWooCommerce.php";
echo ($command . PHP_EOL);shell_exec($command);
...
//$constantsFile = "/var/www/html/wp-content/plugins/email-tunnel/src/EmailTunnel/Constants.class.php";
